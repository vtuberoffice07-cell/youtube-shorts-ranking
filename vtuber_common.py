...
# =============================================================================
# コメント分析（バズ要因の解析）は buzz_analysis.py に移管
# =============================================================================
# ANALYSIS_CATEGORIES と analyze_comments は buzz_analysis.py に移動した。
# 後方互換のため、ここから re-export して既存の `from vtuber_common import ...`
# も動くようにしておく。
